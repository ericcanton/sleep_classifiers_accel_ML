...
Released under Apache 2.0 License. See extended notice at the end of this file.

There are several functions defined here:
    1. logits_to_proba
    2. data_yielder
    3. split_yielder
    4. pr_roc_from_path
...
"""
Copyright 2020 Eric Canton (ericcanton)
